...
save(mut,file = file.path(wkdir,'data','metabric_mut_positions.Rdata'))

png(file.path(wkdir,'figures','plotmafSummary_metabric.png'),res = 150,width = 1080,height = 1080)
...
png(file.path(wkdir,'figures','oncoplot_top30_metabric.png'),res = 150,width = 1080,height = 1080)
